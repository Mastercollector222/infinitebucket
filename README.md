...
watch use wagmi + viem + ConnectKit.
...
| --- | --- | --- |
| `NEXT_PUBLIC_WC_PROJECT_ID` | Yes (for WalletConnect) | WalletConnect/Reown Cloud project id used by ConnectKit. Injected connectors (MetaMask etc.) still work without it. |
